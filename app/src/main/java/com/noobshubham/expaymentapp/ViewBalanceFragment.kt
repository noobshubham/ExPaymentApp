...
import com.noobshubham.expaymentapp.databinding.FragmentViewBalanceBinding
...
class ViewBalanceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Snackbar.make(view, "Server down", Snackbar.LENGTH_INDEFINITE)
            .setAction("try again!", View.OnClickListener { Toast.makeText(activity, "LMAO, Nothing Happened!", Toast.LENGTH_SHORT).show() })
            .show()
    }
